(function (global, factory) {
    ...
    */
    ...
    var config = {
        ...
        fontNames: ['宋体', '微软雅黑', 'Arial', 'Tahoma', 'Verdana', '新宋体', '汉仪青云简', '楷体', '黑体', '等线', '仿宋', 'MS PGothic', 'YU Gothic', 'Brush Script MT', 'Lucida Calligraphy', 'Perpetua Titling MT'],
    ...
    */
    ...
    function FontSize(editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            $title: $('<p>字号</p>'),
            type: 'list', // droplist 以列表形式展示
            list: [{ $elem: $('<span style="font-size: x-small;">10px</span>'), value: '1' },
                { $elem: $('<span style="font-size: small;">13px</span>'), value: '2' },
                ...
                { $elem: $('<span style="font-size: x-large;">24px</span>'), value: '7' },
                { $elem: $('<span style="font-size:28px">28px</span>'), value: '8' },
                { $elem: $('<span style="font-size: xx-large;">32px</span>'), value: '9' },
                { $elem: $('<span style="font-size: 36px;">36px</span>'), value: '10' },
                { $elem: $('<span style="font-size: 38px;">38px</span>'), value: '11' },
                { $elem: $('<span style="font-size: xxx-large;">42px</span>'), value: '12' }
            ],
            onClick: function onClick(value) {
    ...
    */
    ...
    UploadVideo.prototype = {
        ...
        insertLinkVideo: function (link) {
            ...
            //   console.log('123i急急急')
            editor.cmd.do('insertHTML', '<video src="' + link + '" style="width:100%;height: 200px;" controls autobuffer autoplay muted/>');
                    ...
                    if (xhr.readyState === 4) {
                        ...
                        if ((typeof result === 'undefined' ? 'undefined' : _typeof(result)) !== 'object') {
                            try {
                                ...
                                var data = result;
                                _this3.insertLinkVideo('https://www.crm120.cn/api/file'+data.data.url);
                            } catch (ex) {
                                // hook - fail
