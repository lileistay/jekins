<template>
  <div class="print">
    ...
    <div class="header">
      ...
      <div class="text">完成时间：{{ print.treatmentTime }}</div>
    ...
    <div class="table">
      ...
      >
        <el-table-column prop="projectName" label="#治疗项#" />
        <el-table-column prop="thisScribingNum" label="#小计#" width="45" align="right" />
      </el-table>
    </div>
    <div class="line">
      <span class="text">---------------------------------</span>
    ...
    <div class="footer">
      <span class="text">小票是重要凭据，请您妥善保管！</span>
    </div>
  </div>
</template>
