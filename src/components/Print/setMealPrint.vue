<template>
  <div class="print">
    <div class="title">{{ BillTypeName(print.billType) }}</div>
    <div class="header">
      <span>姓名：{{ print.customerName }}</span>
      <span>收费单号：{{ print.orderNumber }}</span>
      <span>收费单类型：{{ BillTypeName(print.billType) }}</span>
    ...
    <div class="detailsTable">
      <el-table
        ...
        class="elTable"
      >
        <el-table-column label="套餐名称" width="300" prop="projectName" />
    ...
    <div class="table">
      <el-table
        ...
        :show-header="false"
      >
        <el-table-column label="项目合计" width="30" prop="name1" />
        <el-table-column label="金额" prop="totalItemsAmount">
          <template>
            {{ total }}
          </template>
        </el-table-column>
        <el-table-column label="应付金额" width="30" prop="name2" />
        <el-table-column label="金额" prop="amountPayable" />
        <el-table-column label="实付金额" width="30" prop="name3" />
