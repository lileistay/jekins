<template>
    <div>
        <div style="height:780px;width:100%;overflow-y:scroll">
                ...
                <div style="position: relative;margin-top:15px" v-for="(items, indexs) in uploadlist.slice(0, 11)" :key="indexs" >
                    ...
                    <div v-if="items.name !== 'logo'">
                        ...
                        <div v-show="items.name == 'jy'">
                            ...
                            <p v-if="blurred && !items.row" class="bulplaceholder">请选择经验</p>
                        </div>
                        ...
                        <div v-show="items.name == 'qz'" class="max">
                            ...
                            <el-input v-model="items.row" :style="{ width: '250px', marginLeft: '10px' }"
                                :maxlength="items.num" show-word-limit size="mini" v-if="items.Name=='电话'||items.Name=='微信'" autocomplete="off" :readonly="readly" @click.nat.native="Readonly($event)" @input="searchPayRecord"></el-input>
                            ...
                            <p v-if="blurred && !items.row" class="bulplaceholder">请输入{{ items.Name }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="project">
                            ...
                            <div class="project_children">
                                ...
                                <div style="margin-left: 5px;">
                                    ...
                                    <el-input v-model="tagname" maxlength="50" focus show-word-limit @blur="projectblur"
          ...
          <div style="width: 950px;margin-left: 80px;margin-top: 20px;display: flex;height: 350px">
            <span style="font-size: 14px;">成员介绍</span>
            <div style="width: 850px;margin-left: 10px;">
              <Wangeditor :flag="true" :content="contentnormal" @catchData="catchDatanew"></Wangeditor>
            </div>
...
<!--            </div>-->
            <div v-for="(items, indexs) in uploadlist.slice(10, 11)" :key="indexs" style="margin-left: 80px;display: flex;">
                ...
                <div class="busic_img">
                    <div v-for="(item, index) in items.value" :key="index" class="busic_img_children"
                        ...
                        <div class="title_success" v-show="item.flags" style="z-index: 100000;margin-top: 5px;">
            ...
            <div>
                <span style="color:red;margin-left: 140px;">建议图片不超过2MB，建议图片尺寸：375*240</span>
            </div>
...
export default {
    ...
    created() {
        ...
        if (flag == 'true') {
          ...
          this.contentnormal=ids.introduce
            let arr = [];
      ...
      catchDatanew(e){
        ...
        submit(val) {
            ...
            let date = {
                ...
                introduce: this.contentnormal,
                deptId: this.treedeptId,
                memberId:ids==undefined?'':ids.memberId,
                labelList: this.tags,
                photoInfo: arrstr,
        ...
        deleter(e, index, val, indexs) {
            e.stopPropagation();
            console.log(this.fileList[val],'asdasd')
          ...
          this.$api.confinementRoom.deleteLocalFile({
            path:this.fileList[val][0].photoAddr
          }).then(res => {
            if (res.code == 200) {
    ...
    data() {
        return {
          ...
          contentnormal:"",
            ...
            newHonorable: [
                {
                    name: "photo", Name: "荣誉风采", desc: '建议图片不超过2MB，建议图片尺寸：120*75',
                    value: [{
                        imgUrl: "",
                        border: '1px dashed #d9d9d9',
                        showflag: false,
