<template>
    <div>
        <Tree :clums="clums" :operation="operation" :isShowfile="isShowfile" :tableData="tableData" :total="total"
            ...
            :statisticsMessage="statisticsMessage" :statistics="statistics"
            :showoperation="showoperation" :row-class-name="rowClassName" :isChangeIndex="isChangeIndex" :typeVuex="typeVuex" @changeCompay="changeCompay" @rowClick="rowClick"
            ...
            <template v-slot:button>
                <div style="" class="opacbutton">
                    ...
                    <div class="opacbutton_children">
                        ...
                        <el-select v-model="value" placeholder="请选择" filterable clearable size="mini">
                    ...
                    <el-button size="mini" icon="el-icon-search" type="primary" plain @keydown.enter.native="getData()" @click.stop="getData()">查询</el-button>
            ...
            <template v-slot:statistics_button>
              ...
              <div style="width:100%;height:30px;display:flex;align-items:center" >
                        <span class="Left" style="margin-left:15px">待审核： <span>{{ tables==null?'':tables.pendingReview }}</span></span>
