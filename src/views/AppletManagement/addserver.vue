            ...
            <div class="basic_title" style="display:flex;flex-wrap:wrap;align-items:center;margin-left: 80px;">
                <div style="margin-top:20px;width: 330px;">
                    ...
                    <el-input placeholder="请输入商品名称" style="width:250px;margin-left:10px" v-model="projectName"
                        size="mini"></el-input>
                    <p v-if="blurred && !projectName" class="bulplaceholder">请输入商品名称</p>
                </div>
                <div style="margin-top:20px;width: 330px;">
                ...
                <div style="margin-top:20px;width: 330px;">
                    ...
                    <span>商品分类</span>
<!--                    <span>-->
                    <el-select filterable v-model="projectType" placeholder="请选择" size="mini" style="margin-left: 20px;"
                               @change="selectchange">
                        <el-option v-for="item in newoptionsl" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                    <el-button style="padding: 5px;margin-left: 5px" type="primary" icon="el-icon-circle-plus-outline" circle v-on:click="focusAll"></el-button>
                    <p v-if="blurred && !projectType" class="bulplaceholder">请选择商品分类</p>
<!--                </span>-->
...
<!--                        @focus="focusAll" size="mini"></el-input>-->
                ...
                <div style="margin-top:20px;width: 330px;">
                    ...
                    <el-input placeholder="请输入分享描述" style="width:250px;margin-left: 10px;" v-model="shareDescription"
                        size="mini"></el-input>
                    <p v-if="blurred && !shareDescription" class="bulplaceholder">请输入分享描述</p>
                </div>
...
<!--                </div>-->
                ...
                <div style="margin-top:20px;margin-right: 10px;">
                    ...
                    <el-select filterable v-model="restrictionType" placeholder="请选择" size="mini">
                ...
                <div style="margin-top:20px;width: 280px;">
                    ...
                    <el-select filterable v-model="newoptionslolpl" placeholder="请选择" size="mini" style="margin-left:20px"
                        :filter-method="pinyingMatch">
                        <el-option v-for="item in newoptionslol" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                    <p v-if="blurred && !newoptionslolpl" class="bulplaceholder">请选择商品类型</p>
                </div>
                <div style="margin-top:20px;width: 320px;" v-if="newoptionslolpl == 1">
                    <span style="color:red;visibility: hidden;">*</span><span>配送方式：</span>
                    <el-select filterable v-model="newoptionslolplps" placeholder="请选择" size="mini" style="margin-left:20px">
                        <el-option v-for="item in newoptionslolps" :key="item.value" :label="item.label"
                            :value="item.value">
                        </el-option>
                    </el-select>
                </div>
                <div style="margin-top:20px;width: 380px;margin-left: 20px;">
                    <span style="color:red">*</span><span>商品标签</span>
                    <el-input show-word-limit maxlength="2" size="mini" style="width: 200px;margin-left: 15px;" v-model="productLabel"></el-input>
                    <p v-if="blurred && !productLabel" class="bulplaceholder">请输入商品标签</p>
                </div>
            ...
            <div class="basic_title">
                <div style="margin-top:20px;width: 240px;margin-left:60px">
                    <span class="Red">*</span>
                    <span class="Right">规格类型</span>
                    <el-select filterable v-model="list[0].specsType" placeholder="请选择" size="mini" style="width: 150px;">
                        <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                    <p v-if="blurred && !list[0].specsType" class="bulplaceholder">请选择规格类型</p>
                </div>
                <div v-for="(item, index) in list"
                    style="display: flex;flex-wrap: wrap;align-items: center;margin-left: 60px;min-height: 50px;">
                    <div style="margin-top:20px;width: 240px;">
                        ...
                        <p v-if="blurred && !item.specs" class="bulplaceholder">请输入商品规格</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max">
                        <span class="Red">*</span>
                        <span class="Right">销售价格</span>
                        <el-input type="number" placeholder="请输入销售价格" style="width:150px;" v-model="item.sellingPrice"
                            size="mini"></el-input>
                        <p v-if="blurred && !item.sellingPrice" class="bulplaceholder">请输入销售价格</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max">
                        <span class="Red">*</span>
                        <span class="Right">商品原价</span>
                        <el-input type="number" placeholder="请输入商品原价" style="width:150px;" v-model="item.originalPrice" size="mini"></el-input>
                        <p v-if="blurred && !item.originalPrice" class="bulplaceholder">请输入商品原价</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max">
                        <span class="Red">*</span>
                        <span class="Right">销售库存</span>
                        <el-input type="number" placeholder="请输入销售库存" style="width:150px;" v-model="item.inventoryNum"
                            size="mini"></el-input>
                        <p v-if="blurred && !item.inventoryNum" class="bulplaceholder">请输入销售库存</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max" v-if="item.wirteFlag">
                        <span class="Red">*</span>
                        <span class="Right">预约金</span>
                        <el-input type="number" placeholder="请输入预约金" style="width:150px;" v-model="item.earnestMoney" size="mini"
                            @blur="newblur($event, index)"></el-input>
                        <p v-if="blurred && !item.earnestMoney" class="bulplaceholder">请输入预约金</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max" v-if="item.wirteFlag">
                        <span class="Red">*</span>
                        <span class="Right">尾款</span>
                        <el-input type="number" placeholder="" style="width:150px;" v-model="item.finalPayment" size="mini"
                            disabled=""></el-input>
                        <p v-if="blurred && !item.finalPayment" class="bulplaceholder">请输入尾款</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;" class="max">
                        <span class="Red">*</span>
                        <span class="Right">虚拟销量</span>
                        <el-input  type="number" placeholder="请输入虚拟销量" style="width:150px;" v-model="item.virtualSales"
                            size="mini"></el-input>
                        <p v-if="blurred && !item.virtualSales" class="bulplaceholder">请输入虚拟销量</p>
                    </div>
                    <div style="margin-top:20px;width: 240px;display: flex;align-items: center;" class="max">
                        ...
                        <div style="display:inline-block">
                            <div style="display:flex;align-items:center;">
                                <div style="display:inline-block;width:150px;height:30px;border:1px solid #eee;background-color:#fff;text-align:center;line-height:30px;white-space:nowrap;overflow: hidden;text-overflow: ellipsis;"
            ...
            <div class="basic_title">
                ...
                <div style="display: flex;height: 350px;width: 1600px;margin-top:20px" v-show="newnoticeFlag">
                    ...
                    <div ref="editor" style="margin-left: 20px;" :key="1"></div>
                </div>
            </div>
            <div class="basic">
            ...
            <div style="display: flex;height: 350px;width: 1600px;margin-top: 20px;">
                ...
                <div ref="editors" style="margin-left: 20px;" :key="2"></div>
            </div>
            ...
            <div style="display: flex;margin-top: 20px;height: 202px;width: 1500px;"
                ...
                <div style="width:90px;margin-left: 60px;">
                    <span style="color:red" >*</span> {{ items.Name }}
                </div>
                    ...
                    <div>
                        ...
                        <div class="busic_img" >
                            <div v-for="(item, index) in items.value" :key="index" class="busic_img_children"
                                ...
                                :style="{ marginLeft: index % 2 == 0 ? '15px' : '10px', marginTop: '10px', border: item.border, width: items.width, height: items.height }"
                                @click="addlist(index, 'title_img' + items.name, indexs + 1)">
        ...
        <sgDialog title="新增商品分类" size="25%" out-top="2%" :dialog="showDig" @handleClose="closeRoomDialogtooth">
            <div slot="out">
<!--                <span style="color:red">*</span> <span>商品分类</span>-->
<!--                <span>-->
<!--                    <el-select filterable v-model="value" placeholder="请选择" size="mini" style="margin-left: 20px;"-->
<!--                        @change="selectchange">-->
<!--                        <el-option v-for="item in newoptionsl" :key="item.value" :label="item.label" :value="item.value">-->
<!--                        </el-option>-->
<!--                    </el-select>-->
<!--                </span>-->
<!--                <el-button type="success" size="mini" style="margin-left: 20px;" @click="newaddlist" v-if="showaddtype">-->
<!--                    去新建分类-->
<!--                </el-button>-->
                <span>新增商品分类</span>
                <el-input v-model="addType" show-word-limit maxlength="8" style="width:150px;margin-left:10px" size="mini"
                    placeholder="请输入分类" ></el-input>
<!--                v-if="showaddType"   @blur="blurType"-->
                <div class=""
                    ...
                    <div style="width: 160px;height: 40px;">
                        <el-button type="primary" size="mini" @click="blurType">确定</el-button>
...
<!--                        <el-button @click="closeRoomDialogteeth" size="mini">取消</el-button>-->
        ...
        <sgDialog title="选择关联产品" size="1100px" out-top="2%" :dialog="projectdialog"
            ...
            <div slot="out">
                ...
                <el-select v-model="categoryId" class="fullInput" filterable clearable size="mini"
                    style="width:150px;margin-left: 10px;" @change="categoryIds">
...
export default {
        ...
        payType(val) {
            if (val == 1) {
                this.list.forEach(value => {
                    value.wirteFlag = true
                })
            } else {
                this.list.forEach(value => {
                    value.wirteFlag = false
                })
                this.list.forEach(value=>{
                    value.earnestMoney=0;
                    value.finalPayment=0;
                })
    ...
    mounted() {
        ...
        if (flag == 'true') {
            ...
            this.productLabel=ids.productLabel
            ...
            this.newoptionslolplps = ids.deliveryType
            let data = {
                deptId: this.deptId,
            ...
            // this.$api.product.productManagement(data).then(res => {
                ...
                // alert(ids.productSpecInfo[0].earnestMoney)
                // console.log(ids.productSpecInfo,'呼啦啦啦')
                if (ids.productSpecInfo[0].earnestMoney == 0) {

                } else {
                    ids.productSpecInfo.forEach(value => {
                        value['wirteFlag'] = true
                    })
                }
                //   if()
            ...
            if (object.head.length == 0) {
                ...
                object.head.forEach((value,index)=>{
                    if(index>0){
                    ...
                    //主要是删除
                        ...
                        if (data.length == 0) {
                            that.$api.confinementRoom.deleteLocalFile({
                                path: that.removelist[0].split("9300")[1]
                            }).then(res => {
                                if (res.code == 200) {
        ...
        // document.querySelectorAll('.w-e-menu')[19].click();
        ...
        this.editors.config.uploadImgMaxSize = 5 * 1024 * 1024 // 将图片大小限制为 2M
        ...
        this.editors.config.customUploadImg = function (files, insert) {
                    // files 是 input 中选中的文件列表
                    // insert 是获取图片 url 后，插入到编辑器的方法
                    // 因为file是个FormData格式的对象所以可以直接通过接口开始上传，不需要做多余操作
                    //虽然文档说是FormData格式，但是我实际使用需要以下操作
        ...
        this.editors.config.onchange = (html) => {
            ...
            let matchReg = /<img.*?(?:>|\/>)/gi;
                    ...
                    that.newcount = data.length;
                    //这一部分主要记录的是第一次的上传
                    if (!that.countFlags) {
                        if (data.length == 1 || that.newcount == 1) {
                            that.newcountFlag = true
                        }
                    }
                    //这一部分主要记录的是上传图片的数量大于1且需要删除图片的时候
                    if (!that.newcountFlags) {
                        if (data.length > 1) {
                            that.newcountFlags = true
                        }
                    }
                    //记录是上传还是删除
                    //上传的话啥事没有
                    if (that.newremovelist.length < data.length) {

                    }
                    //既不是上传也不是删除啥事没有
                    else if (that.newremovelist.length == data.length) {
                    ...
                    //主要是删除
                        ...
                        if (data.length == 0) {
                            that.$api.confinementRoom.deleteLocalFile({
                                path: that.newremovelist[0].split("9300")[1]
                            }).then(res => {
                                if (res.code == 200) {
                                    that.$message.success('删除成功')
                                }
                            ...
                            that.newremovelist.forEach(value => {
                                if (data.indexOf(value) == -1) {
                                    that.$api.confinementRoom.deleteLocalFile({
                                        path: value.split("9300")[1]
                                    }).then(res => {
    ...
    methods: {
        ...
        pinyingMatch(val) {
            if (val) {
                let that = this;
                let result = [];
                that.newoptionslol.forEach((e) => {
                    let m = pinyin.match(e.stnm, val);
                    if (m != false) {
                        result.push(e);
                    }
                });
                //搜索到相应的数据进行显示
                that.newoptionslol = result;
            } else {
                this.newoptionslol = this.newoptionslol.slice(0, 3);
            }
        },
        typeSelect() {
            let datas = {
        ...
        newblur(e, index) {
            ...
            if (num > Number(this.list[index].sellingPrice)) {
                this.$message.error('预约金金额大于销售价格请重新输入');
                this.list[index].earnestMoney = '0'
                return
            } else {
                this.list[index].finalPayment = Number(this.list[index].sellingPrice) - num
            }
        },
        selechColums(row) {
        ...
        add() {
            this.list.push({
                ...
                finalPayment: "",
                earnestMoney: "",
                wirteFlag: this.payType == '1' ? true : false
            })
        },
        newgetData(value) {
        ...
        submit() {
            ...
            if(this.productLabel==''||this.productLabel==null){
            ...
            let newflags = false;
            let newflg = false;
            let writenewflag = false;
            this.list.forEach(value => {
                if (value.specs == '' || value.specs == undefined) {
                    newflg = true
                }
                if (value.sellingPrice == '' || value.sellingPrice == undefined) {
                    flag = true
                }
                if (value.originalPrice == '' || value.originalPrice == undefined) {
                    flags = true
                }
                if (value.inventoryNum == '' || value.inventoryNum == undefined) {
                    newflag = true
                }
                if (value.virtualSales == '' || value.virtualSales == undefined) {
                    newflags = true
                }
                if (value.earnestMoney == '' || value.earnestMoney == null) {
                    writenewflag = true;
                }
            ...
            let data = {
                ...
                photoInfo: arrstr,
                deliveryType: this.newoptionslolplps,
    ...
    data() {
        return {
            ...
            uploadlist: [
                ...
                {
                    name: "head", Name: "商品头图", desc: '建议图片不超过2MB,建议图片尺寸：350*200',
                    value: [{
                        imgUrl: "",
                        border: '1px dashed #d9d9d9',
                        showflag: false,
                ...
                // },
                {
                    name: "share", Name: "分享海报", desc: '建议图片不超过2MB 建议图片尺寸：350*200',
                    value: [{
                        imgUrl: "",
                        border: '1px dashed #d9d9d9',
                        showflag: false,
