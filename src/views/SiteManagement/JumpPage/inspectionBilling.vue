        ...
        <div class="formBody">
          ...
          <el-form class="mentform" :rules="rules" :model="formInline" size="mini">
            <el-row :gutter="20">
              <el-col :span="5">
                <el-form-item label="下单人:">
                  <el-input v-model="userInfo.nickName" disabled style="width: 150px" />
                </el-form-item>
              </el-col>
              <el-col :span="5">
              ...
              <el-col :span="5">
                <el-form-item label="开单科室:" prop="departmentId">
                  <!--                  <el-select v-model="formInline.departmentId" filterable clearable @change="departmentIdChange">-->
            ...
            <el-form-item label="备注:" style="margin-left: 13px;">
              <el-input v-model="formInline.billingRemarks" readonly onfocus="this.removeAttribute('readonly');" type="textarea" style="width: 70%;" />
            </el-form-item>
          </el-form>
        </div>
        <div class="formBody">
...
export default {
  ...
  created() {
    ...
    this.billType = JSON.parse(sessionStorage.getItem('inspectionBillingitem')).billType
    // this.billing = JSON.parse(this.$route.query.billing)
    this.billing = JSON.parse(JSON.parse(sessionStorage.getItem('inspectionBillingitem')).billing)
    ...
    // this.formInline.billingDepartment = this.billing.departmentId
  ...
  methods: {
    ...
    */
    ...
    search: debounce(function() {
      getDicts('dept_laboratory').then(res => {
        if (res) {
    ...
    */
    ...
    handleClick(index, row) {
      ...
      if (!flag) {
        ...
        this.packageProducts.billingDepartment = this.formInline.billingDepartment // 科室ID
    ...
    */
    addOrEdit() {
      ...
      if (this.billing.orderId !== undefined) {
        ...
        this.$set(this.formInline, 'billingDepartment', this.formInline.billingDepartment)
