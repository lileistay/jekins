    ...
    <div    class="management" style="margin-bottom: 20px">
          ...
          <el-row :gutter="15">
            ...
            <el-col v-if="billing.triageType !== 2" :span="5">
              <el-form-item label="推荐人：" prop="secondRecommender">
                <el-select v-model="formInline.secondRecommender" filterable clearable>
                  <el-option
      ...
      <div class="mentediv">
        <div class="formBody">
          ...
          <div v-for="(item, index) in projectList" :key="index" v-loading="loadingList" style="margin-bottom: 5px">
            <div class="billing">
    ...
    addOrEdit() {
      this.$refs.formInline.validate((valid) => {
        if (valid) {
          ...
          // this.orderInfoList.forEach(item => {
          //   // this.$set(item, 'billingRemarks', this.formInline.billingRemarks)
          //   // this.$set(item, 'customerStatus', this.billing.customerStatus)
          // })
