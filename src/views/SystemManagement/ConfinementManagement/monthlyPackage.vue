    ...
    <div class="dept-table">
      ...
      >
        <div slot="searchBar">
          ...
          <span style="font-size: 13px">月子套餐:</span>&nbsp;<el-input v-model="search.equipmentName" size="mini" style="width: 120px;" clearable />&nbsp;
      ...
      <sgDialog :title="dialogTitle" size="400px" :dialog="showDialog" @handleClose="handleClose">
        <div slot="out">
          <el-form ref="form" :model="form" size="mini" :rules="rules" label-width="100px">
            <el-row>
              <el-col :span="18">
                <el-form-item label="月子套餐:" prop="equipmentName">
