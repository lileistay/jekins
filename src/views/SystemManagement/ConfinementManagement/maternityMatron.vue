    ...
    <div class="dept-table">
      ...
      >
        <div slot="searchBar">
          ...
          <span style="font-size: 13px">服务等级:</span>&nbsp;<el-input v-model="search.equipmentName" size="mini" style="width: 120px;" clearable />&nbsp;
          <span style="font-size: 13px">是否显示:</span>&nbsp;
          <el-select v-model="search.status" filterable placeholder="请选择" size="mini" style="width: 120px;" clearable>
            <el-option
      ...
      <sgDialog :title="dialogTitle" size="400px" :dialog="showDialog" @handleClose="handleClose">
        <div slot="out">
          <el-form ref="form" :model="form" size="mini" :rules="rules" label-width="100px">
            <el-row>
              <el-col :span="18">
                <el-form-item label="服务等级:" prop="equipmentName">
