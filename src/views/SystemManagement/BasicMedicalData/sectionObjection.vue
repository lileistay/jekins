...
export default {
  ...
  methods: {
    ...
    getData: debounce(function(isSearch) {
      ...
      var date = {
        deptId: this.deptids === 0 ? this.deptId : this.deptids,
        // prNo: this.deptids === 0 ? this.deptId : this.deptids, // 公司
        prType: 2, // 部门
        performanceDate: this.stringDate
      }
      this.tableData = []
      ...
      // var dept = this.deptids === 0 ? this.deptId : this.deptids
      // 加载过程
