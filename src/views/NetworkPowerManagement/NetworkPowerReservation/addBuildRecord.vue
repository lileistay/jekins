  ...
  <div>
    <div class="progressBar">
      ...
      <div style="float: right">
        ...
        <el-button size="mini" icon="el-icon-close" :loading="submitLoading" @click.stop.native="goBack">关闭</el-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 添加至表格中 添加
    addDataToTable() {
      if (this.selectTreeNode.categoryId === undefined) {
        this.$message.warning('请选择第三级')
        return false
      }
      let flag = false
