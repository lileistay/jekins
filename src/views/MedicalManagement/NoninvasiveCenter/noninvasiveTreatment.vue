<template>
  ...
  <div class="container">
    <slideSearch :options="options">
      <div slot="btnBar">
        <el-button size="mini" type="primary" icon="el-icon-search" @click="getData(true)">查询</el-button>
        <el-button
          v-has-permi="['scribing:deductionRecord:selectTreatment:exportcure']"
          size="mini"
          type="success"
          plain
  ...
  methods: {
    ...
    newexport() {
      ...
      var form = {
        ...
        params:
          {
            begintreatmentTime: data.begintreatmentTime, // 开始治疗时间
            endtreatmentTime: data.endtreatmentTime, // 结束治疗时间
            begintriagePersonTime: data.begintriagePersonTime, // 开始结账时间
            endtriagePersonTime: data.endtriagePersonTime // 结束结账时间
    ...
    getData: debounce(async function(isSearch) {
     ...
     console.log(data,'sagdasd')
      var form = {
        ...
        params:
          {
            begintreatmentTime: data.treatmentTime, // 开始治疗时间
            endtreatmentTime: data.endtreatmentTime, // 结束治疗时间
            begintriagePersonTime: data.triagePersonTime, // 开始结账时间
            endtriagePersonTime: data.endtriagePersonTime // 结束结账时间
