  ...
  <div class="box">
    <div class="box-top">
      ...
      <el-form size="mini" label-width="100px" style="margin-top: 10px">
        ...
        <el-form-item label="备注:">
          <el-input v-model="remark" maxlength="80" type="textarea" style="width: 70%;" />
          <el-button icon="el-icon-plus" type="primary" style="margin-left: 10px" @click="add"> 添加</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog title="" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      ...
      <div style="display: flex;align-items: center;">
        <span style="color:red;">*</span>备注： <el-input maxlength="80" v-model="remarks" type="textarea" style="width: 70%;margin-top: 30px;" />
      </div>
