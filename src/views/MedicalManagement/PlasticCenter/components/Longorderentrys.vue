  ...
  <div>
    <div class="header">
      ...
      <div class="btn">
        ...
        <el-button size="mini" type="primary" plain icon="el-icon-plus" @click="prescriptionsl">放射添加</el-button>

      </div>
    </div>
    <div class="patient_list_right" style="height: 400px;">
...
<span slot="footer" class="dialog-footer">
  ...
  <el-button type="primary" @click="addsnew" size="mini">确 定</el-button>
    ...
    <!-- <el-dialog title="" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      ...
      <span class="demonstration">临嘱停止时间:</span>
...
export default {
  ...
  methods: {
    ...
    prescriptionsl(){
    this.$router.push({ path: 'Adjuvanttherapyfsp' })
  },
  prescription() {
    this.$router.push({ path: 'Adjuvanttherapys' })
  },
  prescriptions() {
    this.$router.push({ path: 'checkoutLines' })
  },
