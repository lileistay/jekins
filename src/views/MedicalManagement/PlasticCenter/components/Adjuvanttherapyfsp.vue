        ...
        <div class="header">
          ...
          <div style="margin-right: 20px">
            <el-button icon="el-icon-search" size="mini" type="primary" plain style="margin-right:3px"
              @click="getAuxiliary">搜索</el-button>
        ...
        <div class="header_middle">
          ...
          <div class="middle">
            <div class="formBody formBody_middle">
              ...
              <el-table border size="mini" :data="tableDatalist" :height="heisl" :header-cell-style="{ 'text-align': 'center' }"
                :cell-style="{ 'text-align': 'center' }" :style="{ 'font-size': '12px' }" style="width: 100%">
                ...
                <el-table-column label="单价" prop="priceOne">
                  <template slot-scope="scope">
                    ...
                    <el-input-number v-model="scope.row.priceOne" :min="0.00" :max="1000000000.01" size="mini" style="width: 100%"
                ...
                <el-table-column label="每次用量" prop="eachTime">
                  <template slot-scope="scope">
                    <!-- <el-input-number
                        ...
                        @input="() => $forceUpdate()"
                      /> -->
                      <el-input-number v-model="scope.row.dosage" :min="0.1"  size="mini" style="width: 100%"
                      @input="() => $forceUpdate()" />
                    <!-- <input type="text" @input="newchangepriceTwo($event, scope.row)" class="changePrice"
                      style="outline: none;width:80px;height: 24px;border: 1px solid #DCDFE6;"> -->
                  </template>
                </el-table-column>
  ...
  computed: {
    ...
    changelistOne(e){
      ...
      addAdvice() {
        ...
        if (this.form.time == '' || this.StartTime == '') {
          this.$message.warning('请选择检验临嘱时间');
          return
        }
        let str = '';
        for (let i = 0; i < 8; i++) {
