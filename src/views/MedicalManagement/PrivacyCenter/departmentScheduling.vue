  ...
  <div class="container">
    ...
    >
        ...
        <el-form size="mini" label-width="120px">
          <el-row>
            ...
            <el-col :span="4">
              ...
              <el-form-item>
                <el-select filterable style="width: 45%" /> -
                <el-select filterable style="width: 45%" />
              </el-form-item>
            </el-col>
            <el-col :span="4">
              ...
              <el-form-item label="美学顾问：">
                <el-select filterable v-model="form.aestheticConsultant"  clearable>
                  <el-option
            ...
            <el-col :span="3">
              ...
              <el-form-item label="医生：">
                <el-select filterable v-model="form.doctorId" clearable>
                  <el-option
      ...
      <div slot="header" class="header">
        <div>
          <span><i class="el-icon-s-data" style="color: #5f94de" />分诊登记</span>
        ...
        <div>
          <el-button size="mini" plain type="primary" icon="el-icon-plus" @click="openManualDialog" v-has-permi="['MedicalManagement:PrivacyCenter:craft']">手工上报</el-button>
          <el-button size="mini" plain type="primary" icon="el-icon-plus" v-has-permi="['MedicalManagement:PrivacyCenter:craftinput']">手工录入</el-button>
          <el-button size="mini" plain type="danger" icon="el-icon-plus" v-has-permi="['MedicalManagement:PrivacyCenter:craftdel']">手工录入删除</el-button>
          <el-button size="mini" plain type="primary" icon="el-icon-bank-card" v-has-permi="['MedicalManagement:PrivacyCenter:craftyear']">年卡</el-button>
          <el-button size="mini" plain type="primary" icon="el-icon-bank-card" v-has-permi="['MedicalManagement:PrivacyCenter:craftfomr']">套餐</el-button>
          <el-button size="mini" plain type="primary" icon="el-icon-plus" v-has-permi="['MedicalManagement:PrivacyCenter:craftfz']">分诊登记</el-button>
        </div>
      </div>
