          ...
          <div v-if="rights">
            <div style="margin-bottom: 20px">
              ...
              >
                ...
                <el-table-column prop="billNumber" width="165" label="收费单编号">
                ...
                <el-table-column prop="feeSource" label="收费类型">

                </el-table-column>
                <el-table-column prop="amountReceived" label="结账金额" />
                <el-table-column prop="operatorName" label="下单人" />
              </el-table>
            </div>
            <!-- <div class="rights">
  ...
  export default {
    ...
    methods: {
      ...
      getData: debounce(function(isSearch) {
        ...
        this.$api.confinementRoom.getHospitalizationExpenses(data).then(res => {
      ...
      async handleCurrentChange(val) {
        ...
        this.ListData = []
          var data = {
            deptId: this.deptId,
          costType:val[1].expenseTypeId,
          startTime:this.form.createTime ? this.form.createTime[0] : null,
          endTime:this.form.createTime ? this.form.createTime[1] : null
          }

        await  this.$api.confinementRoom.getExpenseByExpenseType(data).then(res => {
          if (res) {
